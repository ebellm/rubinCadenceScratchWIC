...
or can be re-imported here."""
    ...
    def getLallementEBV(self):
        ...
        # pass the distance array generated to the instance
    ...
    def showLos(self, ax=None, alpha=1.0, lw=1, zorder=5, noLabel=False):
...
model.
    ...
    dumSamp = ax2.scatter(vL, vB, c=maxBovy, zorder=2, cmap='Greys_r', \
